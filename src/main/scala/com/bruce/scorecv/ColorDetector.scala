...
/** Example of using a strategy pattern in algorithm design.
  ...
  *
  * This Scala code functionally is equivalent to C++ code in chapter 3 of OpenCV 2 Computer Vision Application
  * Programming Cookbook, "Using the Strategy pattern in algorithm design".
